...
import Resource from '../views/common/resource/resource';
import Blog from '../views/common/blogs/blog';
import Restwo from '../views/common/resource/resource2';
import Resone from '../views/common/resource/resource1';
Vue.use(VueRouter);
